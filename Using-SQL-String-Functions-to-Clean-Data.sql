...
SELECT first_name, LENGHT(first_name) as characters_num
FROM employees
...
SELECT cusomer_name, region, country, 
...
SELECT TRIM(leading ' ' FROM ' Coursera-Guided-Projecs ');

-- 5.2: Trim the word Coursera-Guided-Projects
SELECT TRIM(trailing ' ' FROM ' Coursera-Guided-Projecs ');

-- 5.3: Trim the word Coursera-Guided-Projects
SELECT TRIM(both ' ' FROM ' Coursera-Guided-Projecs ');

-- 5.4: Trim the word Coursera-Guided-Projects
SELECT TRIM(' Coursera-Guided-Projecs ');

-- 5.5: Right trim the word Coursera-Guided-Projects
SELECT RTRIM(' Coursera-Guided-Projecs ');

-- 5.6: Left trim the word Coursera-Guided-Projects
SELECT LTRIM(' Coursera-Guided-Projecs ');
...
SELECT order_id, STRING_AGG(product_id, ', ') as product_ordered
FROM sales
GROUP BY order_id
ORDER BY order_id;
...
SELECT customer_name, country, city, state,
	COALESCE( country, city, state, 'No Adress') as cust_add
FROM customers;
